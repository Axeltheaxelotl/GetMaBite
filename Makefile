...
INCLUDES  = -I./srcs -I./srcs/serverConfig -I./srcs/epollDansTaGrosseDaronne -I./srcs/parser -I./srcs/runner -I./srcs/Utils -I./srcs/Logger
...
SRCS      = ./srcs/main.cpp \
            ...
            ./srcs/epollDansTaGrosseDaronne/epollDansTaGrosseDaronne.cpp \
