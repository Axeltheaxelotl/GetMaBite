...
<table align="center" style="width: 100%; max-width: 600px; border-collapse: collapse; padding: 0 20px;">
  <tr>
    <td style="text-align: left; padding: 10px; border: 1px solid #ddd; vertical-align: top;">
      <p>---
### **RFC 2616 (HTTP/1.1)**  
====================
...
---
    ...
    <td style="text-align: right; padding: 10px; border: 1px solid #ddd; vertical-align: top;">
      <p>## Priorités
